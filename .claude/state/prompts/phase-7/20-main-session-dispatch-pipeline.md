...
> 보관 경로: `.claude/state/prompts/phase-7/20-main-session-dispatch-pipeline.md`
> 작성: 프롬프트 엔지니어 세션 / 2026-09-10
>
> 짝: `20-engine-dev-pipeline.md`
...
- [ ] 이번 위임 파일이 `20-engine-dev-pipeline.md`로 있는가
...
| `.claude/state/prompts/phase-7/20-engine-dev-pipeline.md` | **이번에 위임할 프롬프트 원문** |
...
```powershell
Select-String -Path docs/ONDOLOG_MASTER.md -Pattern 'DOC_REVISION: 2026-09-10-r20'
```
...
애매하면 에이전트가 판정하게 두십시오 — 1부가 그 절차입니다.
...
.claude/state/prompts/phase-7/20-engine-dev-pipeline.md 를
...
## 착수 조건 (최우선)
- ① Edge Function이 tsc 범위 안: {O/X — 근거}
