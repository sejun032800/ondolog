...
- 연애 온도 결합 공식 / DNA base_score 궁합 공식 / OVR 포지션 가중치 (Phase 2 자리표시자 해소)
...
| Phase 6 중 | 얼굴 매칭 임계값 실측 확정 | 기술 |
| Phase 7 전 | ~~AI 매거진 메이커 캐릭터~~ → **폐기** | 콘텐츠 |
| Phase 7 전 | LLM 한국어 품질 실측 비교 | 기술 |
| Phase 7 전 | 채팅 데이터 AI 활용 고지 문구 | 법무 (필수) |
| Phase 7 전 | **연애 온도 결합 공식** (Phase 2 자리표시자) | 기술 |
| Phase 7 전 | **DNA base_score 궁합 공식** (Phase 2 자리표시자) | 기술 |
| Phase 7 전 | **OVR 포지션 가중치 + 규준집단** (Phase 2 자리표시자) | 기술 |
| Phase 7 전 | **베이지안 수축 보정 파라미터** (Phase 2 자리표시자) | 기술 |
